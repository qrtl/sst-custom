...
class ProductCategoryAdapter(Component):
    ...
    def search(self, filters=None, from_date=None, to_date=None):
        ...
        return self._call(self._odoo_model, "search", [filters] if filters else [{}])
    ...
    def read(self, id, storeview_id=None, attributes=None):
        ...
        return self._call(self._odoo_model, "read", id)
    ...
    def tree(self, parent_id=None, storeview_id=None):
        ...
        tree = self._call("%s.tree" % self._odoo_model, [parent_id, storeview_id])
        return filter_ids(tree)

    def move(self, categ_id, parent_id, after_categ_id=None):
        return self._call(
            "%s.move" % self._odoo_model, [categ_id, parent_id, after_categ_id]
        )

    def get_assigned_product(self, categ_id):
        return self._call("%s.assignedProducts" % self._odoo_model, [categ_id])

    def assign_product(self, categ_id, product_id, position=0):
        return self._call(
            "%s.assignProduct" % self._odoo_model,
            [categ_id, product_id, position, "id"],
        )

    def update_product(self, categ_id, product_id, position=0):
        return self._call(
            "%s.updateProduct" % self._odoo_model,
            [categ_id, product_id, position, "id"],
        )

    def remove_product(self, categ_id, product_id):
        return self._call(
            "%s.removeProduct" % self._odoo_model, [categ_id, product_id, "id"]
        )
