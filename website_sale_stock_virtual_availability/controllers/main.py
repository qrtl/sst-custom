...
class WebsiteSale(WebsiteSale):
    ...
    # i.e. https://github.com/odoo/odoo/blob/11.0/addons/website_sale_stock/controllers/main.py#L11-L27
    def get_attribute_value_ids(self, product):
        ...
        for r, variant in izip(res, request.env['product.product'].sudo().browse(variant_ids)):
            ...
            r[4].update({
                'website_sale_available_qty': variant.sudo().website_sale_available_qty,
            })
        return res
