...
var QWeb = core.qweb;
var xml_load = ajax.loadXML('/website_sale_stock_virtual_availability/static/src/xml/website_sale_stock_product_availability.xml', QWeb);
            ...
            if (_.isEmpty(_.difference(variant_ids[k][1], values))) {
                ...
                if(_.contains(['always', 'threshold'], info['inventory_availability'])) {
                    ...
                    if(qty > info['website_sale_available_qty']) {
                        $parent.find('input[name="add_qty"]').val(info['website_sale_available_qty'] || 1);
                    }
                    if(qty > info['website_sale_available_qty'] || info['website_sale_available_qty'] < 1 || qty < 1) {
