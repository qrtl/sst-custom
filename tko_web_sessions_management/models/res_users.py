            ...
            if session_ids:
                if request.httprequest.path[:5] == '/web/' or \
                    ...
                    for s in open_sessions:
                        ...
                        cr.execute(
                            'UPDATE ir_sessions '
                            'SET date_expiration=%s, session_duration=%s '
                            'WHERE id= %s',
                            (date_expiration,
                             session_duration,
                             session_id.id,))
