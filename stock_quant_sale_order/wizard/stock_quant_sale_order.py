...
class QuantSaleOrderWizard(models.TransientModel):
    ...
    def action_stock_quant_saleorder(self):
        '''This methos create a sale order.'''
        ...
        if any(q.sale_order_id != False for q in quant_ids):
            raise UserError(_('Some of the selected quants are already create sale order.'))
